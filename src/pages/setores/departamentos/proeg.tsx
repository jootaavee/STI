...
import "../../css/departamentos/proeg.css";
...
const proeg = () => {
    return (<>
        <div className='container_proeg'>
            <Detalhe />
            <div className='topo_proeg'>
                <div className='voltar_proeg'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_proeg' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_proeg" />
            </div>
            <div className='centro_proeg'>
                <div className='dados_proeg'>
                    <div className='superior_dados_proeg'>
                        <div className='esquerda_dados_proeg'>
                            <div className='data_proeg'>
                                    {<Data />}
                            </div>
                            <div className='relogio_proeg'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_proeg'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_proeg'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_proeg'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_proeg'>
                ...
                <div className='chamados_proeg'>
                    <div className='grafico_pizza_proeg'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_proeg">
                        <div className='titulo_dados_proeg'>
