...
import "../../css/departamentos/propeg.css";
...
const propeg = () => {
    return (<>
        <div className='container_propeg'>
            <Detalhe />
            <div className='topo_propeg'>
                <div className='voltar_propeg'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_propeg' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_propeg" />
            </div>
            <div className='centro_propeg'>
                <div className='dados_propeg'>
                    <div className='superior_dados_propeg'>
                        <div className='esquerda_dados_propeg'>
                            <div className='data_propeg'>
                                    {<Data />}
                            </div>
                            <div className='relogio_propeg'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_propeg'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_propeg'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_propeg'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_propeg'>
                ...
                <div className='chamados_propeg'>
                    <div className='grafico_pizza_propeg'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_propeg">
                        <div className='titulo_dados_propeg'>
