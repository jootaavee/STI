...
import "../../css/departamentos/epilogo.css";
...
const epilogo = () => {
    return (<>
        <div className='container_epilogo'>
            <Detalhe />
            <div className='topo_epilogo'>
                <div className='voltar_epilogo'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_epilogo' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_epilogo" />
            </div>
            <div className='centro_epilogo'>
                <div className='dados_epilogo'>
                    <div className='superior_dados_epilogo'>
                        <div className='esquerda_dados_epilogo'>
                            <div className='data_epilogo'>
                                    {<Data />}
                            </div>
                            <div className='relogio_epilogo'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_epilogo'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_epilogo'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_epilogo'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_epilogo'>
                ...
                <div className='chamados_epilogo'>
                    <div className='grafico_pizza_epilogo'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_epilogo">
                        <div className='titulo_dados_epilogo'>
