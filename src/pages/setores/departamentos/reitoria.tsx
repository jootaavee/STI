...
import "../../css/departamentos/reitoria.css";
...
const reitoria = () => {
    return (<>
        <div className='container_reitoria'>
            <Detalhe />
            <div className='topo_reitoria'>
                <div className='voltar_reitoria'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_reitoria' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_reitoria" />
            </div>
            <div className='centro_reitoria'>
                <div className='dados_reitoria'>
                    <div className='superior_dados_reitoria'>
                        <div className='esquerda_dados_reitoria'>
                            <div className='data_reitoria'>
                                    {<Data />}
                            </div>
                            <div className='relogio_reitoria'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_reitoria'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_reitoria'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_reitoria'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_reitoria'>
                ...
                <div className='chamados_reitoria'>
                    <div className='grafico_pizza_reitoria'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_reitoria">
                        <div className='titulo_dados_reitoria'>
