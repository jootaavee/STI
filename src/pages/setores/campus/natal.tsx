...
const natal = () => {
    return (<>
        <div className='container_natal'>
            <Detalhe />
            <div className='topo_natal'>
                <div className='voltar_natal'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_natal' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_natal" />
            </div>
            <div className='centro_natal'>
                <div className='dados_natal'>
                    <div className='superior_dados_natal'>
                        <div className='esquerda_dados_natal'>
                            <div className='data_natal'>
                                    {<Data />}
                            </div>
                            <div className='relogio_natal'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_natal'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_natal'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_natal'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_natal'>
                ...
                <div className='chamados_natal'>
                    <div className='grafico_pizza_natal'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_natal">
                        <div className='titulo_dados_natal'>
