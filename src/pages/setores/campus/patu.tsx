...
const patu = () => {
    return (<>
        <div className='container_patu'>
            <Detalhe />
            <div className='topo_patu'>
                <div className='voltar_patu'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_patu' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_patu" />
            </div>
            <div className='centro_patu'>
                <div className='dados_patu'>
                    <div className='superior_dados_patu'>
                        <div className='esquerda_dados_patu'>
                            <div className='data_patu'>
                                    {<Data />}
                            </div>
                            <div className='relogio_patu'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_patu'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_patu'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_patu'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_patu'>
                ...
                <div className='chamados_patu'>
                    <div className='grafico_pizza_patu'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_patu">
                        <div className='titulo_dados_patu'>
