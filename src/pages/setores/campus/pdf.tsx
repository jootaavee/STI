...
const pdf = () => {
    return (<>
        <div className='container_pdf'>
            <Detalhe />
            <div className='topo_pdf'>
                <div className='voltar_pdf'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_pdf' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_pdf" />
            </div>
            <div className='centro_pdf'>
                <div className='dados_pdf'>
                    <div className='superior_dados_pdf'>
                        <div className='esquerda_dados_pdf'>
                            <div className='data_pdf'>
                                    {<Data />}
                            </div>
                            <div className='relogio_pdf'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_pdf'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_pdf'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_pdf'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_pdf'>
                ...
                <div className='chamados_pdf'>
                    <div className='grafico_pizza_pdf'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_pdf">
                        <div className='titulo_dados_pdf'>
