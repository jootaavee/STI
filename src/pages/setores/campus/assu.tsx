...
const assu = () => {
    return (<>
        <div className='container_assu'>
            <Detalhe />
            <div className='topo_assu'>
                <div className='voltar_assu'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_assu' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_assu" />
            </div>
            <div className='centro_assu'>
                <div className='dados_assu'>
                    <div className='superior_dados_assu'>
                        <div className='esquerda_dados_assu'>
                            <div className='data_assu'>
                                    {<Data />}
                            </div>
                            <div className='relogio_assu'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_assu'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_assu'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_assu'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_assu'>
                ...
                <div className='chamados_assu'>
                    <div className='grafico_pizza_assu'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_assu">
                        <div className='titulo_dados_assu'>
