...
const caico = () => {
    return (<>
        <div className='container_caico'>
            <Detalhe />
            <div className='topo_caico'>
                <div className='voltar_caico'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_caico' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_caico" />
            </div>
            <div className='centro_caico'>
                <div className='dados_caico'>
                    <div className='superior_dados_caico'>
                        <div className='esquerda_dados_caico'>
                            <div className='data_caico'>
                                    {<Data />}
                            </div>
                            <div className='relogio_caico'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_caico'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_caico'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_caico'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_caico'>
                ...
                <div className='chamados_caico'>
                    <div className='grafico_pizza_caico'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_caico">
                        <div className='titulo_dados_caico'>
