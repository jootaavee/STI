...
import "../../css/faculdades/faen.css";
...
const faen = () => {
    return (<>
        <div className='container_faen'>
            <Detalhe />
            <div className='topo_faen'>
                <div className='voltar_faen'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_faen' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_faen" />
            </div>
            <div className='centro_faen'>
                <div className='dados_faen'>
                    <div className='superior_dados_faen'>
                        <div className='esquerda_dados_faen'>
                            <div className='data_faen'>
                                    {<Data />}
                            </div>
                            <div className='relogio_faen'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_faen'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_faen'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_faen'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_faen'>
                ...
                <div className='chamados_faen'>
                    <div className='grafico_pizza_faen'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_faen">
                        <div className='titulo_dados_faen'>
