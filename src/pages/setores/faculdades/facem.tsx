...
import "../../css/faculdades/facem.css";
...
const facem = () => {
    return (<>
        <div className='container_facem'>
            <Detalhe />
            <div className='topo_facem'>
                <div className='voltar_facem'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_facem' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_facem" />
            </div>
            <div className='centro_facem'>
                <div className='dados_facem'>
                    <div className='superior_dados_facem'>
                        <div className='esquerda_dados_facem'>
                            <div className='data_facem'>
                                    {<Data />}
                            </div>
                            <div className='relogio_facem'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_facem'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_facem'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_facem'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_facem'>
                ...
                <div className='chamados_facem'>
                    <div className='grafico_pizza_facem'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_facem">
                        <div className='titulo_dados_facem'>
