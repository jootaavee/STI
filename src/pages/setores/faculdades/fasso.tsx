...
import "../../css/faculdades/fasso.css";
...
const fasso = () => {
    return (<>
        <div className='container_fasso'>
            <Detalhe />
            <div className='topo_fasso'>
                <div className='voltar_fasso'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_fasso' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_fasso" />
            </div>
            <div className='centro_fasso'>
                <div className='dados_fasso'>
                    <div className='superior_dados_fasso'>
                        <div className='esquerda_dados_fasso'>
                            <div className='data_fasso'>
                                    {<Data />}
                            </div>
                            <div className='relogio_fasso'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_fasso'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_fasso'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_fasso'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_fasso'>
                ...
                <div className='chamados_fasso'>
                    <div className='grafico_pizza_fasso'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_fasso">
                        <div className='titulo_dados_fasso'>
