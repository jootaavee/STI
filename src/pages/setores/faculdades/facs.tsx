...
import "../../css/faculdades/facs.css";
...
const facs = () => {
    return (<>
        <div className='container_facs'>
            <Detalhe />
            <div className='topo_facs'>
                <div className='voltar_facs'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_facs' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_facs" />
            </div>
            <div className='centro_facs'>
                <div className='dados_facs'>
                    <div className='superior_dados_facs'>
                        <div className='esquerda_dados_facs'>
                            <div className='data_facs'>
                                    {<Data />}
                            </div>
                            <div className='relogio_facs'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_facs'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_facs'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_facs'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_facs'>
                ...
                <div className='chamados_facs'>
                    <div className='grafico_pizza_facs'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_facs">
                        <div className='titulo_dados_facs'>
