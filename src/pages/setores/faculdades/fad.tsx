...
const fad = () => {
    return (<>
        <div className='container_fad'>
            <Detalhe />
            <div className='topo_fad'>
                <div className='voltar_fad'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_fad' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_fad" />
            </div>
            <div className='centro_fad'>
                <div className='dados_fad'>
                    <div className='superior_dados_fad'>
                        <div className='esquerda_dados_fad'>
                            <div className='data_fad'>
                                    {<Data />}
                            </div>
                            <div className='relogio_fad'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_fad'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_fad'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_fad'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_fad'>
                ...
                <div className='chamados_fad'>
                    <div className='grafico_pizza_fad'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_fad">
                        <div className='titulo_dados_fad'>
