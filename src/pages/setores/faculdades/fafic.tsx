...
import "../../css/faculdades/fafic.css";
...
const fafic = () => {
    return (<>
        <div className='container_fafic'>
            <Detalhe />
            <div className='topo_fafic'>
                <div className='voltar_fafic'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_fafic' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_fafic" />
            </div>
            <div className='centro_fafic'>
                <div className='dados_fafic'>
                    <div className='superior_dados_fafic'>
                        <div className='esquerda_dados_fafic'>
                            <div className='data_fafic'>
                                    {<Data />}
                            </div>
                            <div className='relogio_fafic'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_fafic'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_fafic'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_fafic'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_fafic'>
                ...
                <div className='chamados_fafic'>
                    <div className='grafico_pizza_fafic'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_fafic">
                        <div className='titulo_dados_fafic'>
