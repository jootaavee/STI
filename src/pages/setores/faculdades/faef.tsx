...
import "../../css/faculdades/faef.css";
...
const faef = () => {
    return (<>
        <div className='container_faef'>
            <Detalhe />
            <div className='topo_faef'>
                <div className='voltar_faef'>
                    <Link to='/tela2'>
                        <FaArrowLeft className='voltar_tela_faef' style={{ color: 'white', fontSize: '300%' }} />
                    </Link>
                </div>
                <div className="logo_faef" />
            </div>
            <div className='centro_faef'>
                <div className='dados_faef'>
                    <div className='superior_dados_faef'>
                        <div className='esquerda_dados_faef'>
                            <div className='data_faef'>
                                    {<Data />}
                            </div>
                            <div className='relogio_faef'>
                                    {<Relogio />}
                            </div>
                        </div>
                        <div className='direita_dados_faef'>
                            <div><h1 className='chamados_por_semana'>Chamados por semana</h1></div>
                            <div className='MAT_tela_faef'>
                                <LineChartComponent data={data2} />
                            </div>
                        </div>
                    </div>
                    <div className='inferior_dados_faef'>
                        <Link to="/tela5">
                            <div className='descricao_chamados_tela_faef'>
                ...
                <div className='chamados_faef'>
                    <div className='grafico_pizza_faef'>
                        <PieChartComponent data={data} />
                    </div>
                    <div className="dados_chamados_faef">
                        <div className='titulo_dados_faef'>
